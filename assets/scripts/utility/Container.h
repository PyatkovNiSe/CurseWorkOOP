#ifndef COURSEWORKOOP_ASSETS_SCRIPTS_UTILITY_CONTAINER_H
#define COURSEWORKOOP_ASSETS_SCRIPTS_UTILITY_CONTAINER_H
...
class Container {
 ...
 public:
  ...
  Container(const std::initializer_list<std::pair<Key, Value>> &list) : data_(
	  list.begin(),
	  list.end()) {}
...
#endif //COURSEWORKOOP_ASSETS_SCRIPTS_UTILITY_CONTAINER_H
